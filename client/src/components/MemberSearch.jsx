...
/* ─────────────────────────────────────────
   MemberSearch
   Debounced email search with result list.
   Calls onAdd(user) when a result is picked.
───────────────────────────────────────── */
  ...
  const handleSearch = (value) => {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        // Filter out members already in the group / already selected
    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-11 bg-gray-50 border border-gray-200 rounded-xl
                     pl-9 pr-10 text-sm focus:outline-none focus:border-emerald-500
      ...
      {/* Results dropdown */}
      {results.length > 0 && (
        <div className="absolute z-10 w-full mt-1.5 bg-white border border-gray-100
