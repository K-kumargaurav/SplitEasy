          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await api.put("/users/profile", { paymentDetailsPublic: next });
                  toast.success(next ? "Payment details visible to group members" : "Payment details hidden");
                } catch {
                  setProfileData((p) => ({ ...p, paymentDetailsPublic: !next }));
              ...
              className={`shrink-0 flex items-center gap-1.5 px-3 h-8 rounded-xl text-xs font-semibold
                          transition touch-manipulation select-none
                          ${(profileData?.paymentDetailsPublic ?? true)
